...
with gr.Blocks(css=css) as iface:
    gr.Markdown("# 🚀 AI Code Fixer & Optimizer (Multi-Language)", elem_id="title")
    gr.Markdown("### By Arnav", elem_id="subtitle")
    
    code_input = gr.Textbox(lines=10, placeholder="Paste Your Code Here:", label="Paste Your Code")  # Increased height
    with gr.Row():
    ...
    output_box = gr.Textbox(label="AI Output (Fixed Code & Explanation)", lines=10)  # Increased height
